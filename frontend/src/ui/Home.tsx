    ...
    <div>
      ...
      <div id="about" className="pt-10">
        <div className="text-center border-2 border-pink-200 p-4 mx-6 sm:mx-14">
          ...
          <p className="text-sm sm:text-base md:pl-32 md:pr-32 pt-5">{about}</p>
        </div>
      </div>
