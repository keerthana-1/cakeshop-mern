        ...
        <div className="flex justify-between p-10">
            ...
            <div>
                 ...
                 <table className="min-w-full border border-pink-200">
                    <thead>
                    <tr>
                        <th className="py-2 px-4 border-b bg-pink-200 text-left">Username</th>
                        <th className="py-2 px-4 border-b bg-pink-200 text-left">No. of Orders</th>
                    </tr>
                    </thead>
                    <tbody>
                    {
                        ...
                        <tr key={key}>
                            <td className="py-2 px-4 border-b border-pink-200">{topuser._id}</td>
                            <td className="py-2 px-4 border-b border-pink-200">{topuser.totalOrders}</td>
                        </tr>
                        ))
                    }
                    </tbody>
